...
class coordinates_box(object):
    ...
    def createcoordinates(self,
        ...
        # Save coordinates:
        f = open('SAVE_PATH' + 'circles_' + 'COMPANY_SEARCH' + '_python_mined.csv', 'w')
        w = csv.writer(f)
...
def runsearch():
    ...
    SAVE_PATH = 'H:/'
    COMPANY_SEARCH = 'restaurants'
    f = open(SAVE_PATH + COMPANY_SEARCH + '_python_mined.csv', 'w')
    w = csv.writer(f)
    ...
    # OUTPUT LOG to CSV
    f = open('SAVE_PATH' + 'log_' + 'COMPANY_SEARCH '+ '_python_mined.csv', 'w')
    w = csv.writer(f)
